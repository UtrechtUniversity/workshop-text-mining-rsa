...
1. The textbook that was used for this course, _Text-Mining with I-Analyzer & R_.
    ...
    _Hint:_ check the CITATION.cff file in the GitHub repository for the book.

2. The _Text Mining with R: A Tidy Approach_ book.

    _Hint:_ Check Google Scholar.
...
When you are completed with your assignment and the code chunks are running smoothly, you can click the 'Knit' button in the RStudio menu to render/convert the R Markdown file to HTML format. T
