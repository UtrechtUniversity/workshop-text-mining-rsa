...
<embed src="slides/text_mining_with_R_slides.pdf" type="application/pdf" width="100%" height="600px" />
...
<li>The function `print()` displayed the custom message "Good luck everyone!" as an encouragement to all the students following the course.</li>
