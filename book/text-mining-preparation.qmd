...
[ianalyzer_query.csv](../data/ianalyzer_query.csv)

## Download Lexicon

Download the lexicon file linked below and place it in the `lexicons` folder:

[NRC_lexicon.txt](../lexicons/NRC_lexicon.txt)

## Download the R Markdown Files

Download the following Rmd files:

-  [text_mining_with_R_notebook_empty.Rmd](../exercises/text_mining_with_R_notebook_empty.Rmd)
-  [text_mining_with_R_notebook_solutions.Rmd](../exercises/text_mining_with_R_notebook_solutions.Rmd)
